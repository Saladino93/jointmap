...
srun ~/.conda/envs/lenscarf/bin/python ../scripts/param_joint.py -c ../scripts/configs/official_so_a_disabled_check_factor_2.yaml
srun ~/.conda/envs/lenscarf/bin/python ../scripts/param_joint.py -c ../scripts/configs/official_so_a_disabled_check_factor_2_no_alpha.yaml